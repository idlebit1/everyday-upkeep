...
- Five completed guides per category (the 40 base tasks plus a fifth in every category) — home: `gutters.html`, `replace-hvac-filter.html`, `test-smoke-detectors.html`, `flush-water-heater.html`, `clean-dryer-vent.html`; kitchen: `sharpen-knives.html`, `clean-dishwasher-filter.html`, `clean-refrigerator-coils.html`, `descale-coffee-maker.html`, `clean-garbage-disposal.html`; personal: `replace-toothbrush.html`, `dentist-visit.html`, `physical-exam.html`, `replace-sunscreen.html`, `clean-water-bottle.html`; vehicle: `oil-change.html`, `check-tire-pressure.html`, `tire-rotation.html`, `replace-wiper-blades.html`, `replace-cabin-air-filter.html`; wardrobe: `wash-bedding.html`, `replace-running-shoes.html`, `rotate-mattress.html`, `replace-pillows.html`, `wash-pillows.html`; equipment: `clean-bike-chain.html`, `bike-tune-up.html`, `replace-helmet.html`, `battery-health-check-phone.html`, `wash-yoga-mat.html`; tools: `sharpen-mower-blade.html`, `service-snow-blower.html`, `sharpen-pruners.html`, `replace-cordless-batteries.html`, `sharpen-chainsaw-chain.html`; yard: `clean-grill.html`, `fertilize-lawn.html`, `winterize-sprinklers.html`, `pressure-wash.html`, `aerate-lawn.html`; pets: `trim-pet-nails.html`, `flea-tick-treatment.html`, `annual-vet-checkup.html`, `clean-litter-box.html`, `bathe-pet.html`; other: `backup-data.html`, `review-insurance.html`, `update-emergency-kit.html`, `weekly-money-review.html`, `digital-cleanup.html`
